...
One obvious advantage is that it allows you to collect data without interacting with people face to face, like in the middle of a pandemic. Face-to-face data collection only just restarted here in PPLS (September 2021) and is still quite restricted, so there are obvious advatanges to sidestepping those restrictions/risks by collecting data online.
